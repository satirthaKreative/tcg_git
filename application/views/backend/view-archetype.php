<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>View Archetype</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">View Archetype</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">View Archetype</h3> 
      ...
      $.ajax({
        ...
        success: function(event){
          ...
          for(var i = 0; i < event.length; i++){
            ...
            html += "<tr><td>"+j_id+"</td><td>"+event[i].format_name+"</td><td>"+event[i].archetype_filter+"</td><td>"+event[i].archetype_name+"</td></tr>";
            j_id++;
          }
