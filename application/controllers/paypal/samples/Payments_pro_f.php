...
class Payments_pro_f extends CI_Controller {
	...
	function Do_direct_payment()
	{
		...
		else
		{
			...
			$arrEmp = [
				...
				'cNumber' => $_POST['acct'],
				'cexpireDateM' => $_POST['expM'],
				'cexpireDateY' => $_POST['expY'],
				'cvvNumber' => $_POST['CVV2'],
				'cusAddress' => $_POST['Street'].' '.$_POST['Street2'].' '.$_POST['City'].' '.$_POST['State'].' '.$_POST['CountryCode'],
				'endDate' => $final,
...
/* End of file Payments_pro_f.php */
/* Location: ./application/controllers/paypal/samples/Payments_pro_f.php */